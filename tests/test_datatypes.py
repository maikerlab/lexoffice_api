import unittest
import uuid
from src.lexoffice import datatypes as dt
...
class TestVoucher(unittest.TestCase):
    ...
    def test_voucher_duedate_not_available(self):
        voucher = {
            "id": "57b8d457-1fb6-4ae9-944a-9fe763da2aff",
            "voucherType": "purchaseinvoice",
            "voucherStatus": "open",
    ...
    def test_voucher_duedate_none(self):
        voucher = {
            "id": "57b8d457-1fb6-4ae9-944a-9fe763da2aff",
            "voucherType": "purchaseinvoice",
            "voucherStatus": "open",
...
class TestInvoice(unittest.TestCase):
    ...
    def test_invoice_duedate_not_available(self):
        invoice = {
            "id": "e9066f04-8cc7-4616-93f8-ac9ecc8479c8",
            "organizationId": "aa93e8a8-2aa3-470b-b914-caad8a255dd8",
            "createdDate": "2017-04-24T08:20:22.528+02:00",
    ...
    def test_invoice_duedate_none(self):
        invoice = {
            "id": "e9066f04-8cc7-4616-93f8-ac9ecc8479c8",
            "organizationId": "aa93e8a8-2aa3-470b-b914-caad8a255dd8",
            "createdDate": "2017-04-24T08:20:22.528+02:00",
